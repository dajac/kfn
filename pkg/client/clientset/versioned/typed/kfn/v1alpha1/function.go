...
import (
	...
	scheme "github.com/dajac/kfn/pkg/client/clientset/versioned/scheme"
...
func newFunctions(c *KfnV1alpha1Client, namespace string) *functions {
	return &functions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *functions) UpdateStatus(function *v1alpha1.Function) (result *v1alpha1.Function, err error) {
	result = &v1alpha1.Function{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("functions").
