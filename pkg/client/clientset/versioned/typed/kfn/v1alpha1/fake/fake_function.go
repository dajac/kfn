...
type FakeFunctions struct {
	Fake *FakeKfnV1alpha1
	ns   string
}

var functionsResource = schema.GroupVersionResource{Group: "kfn.dajac.io", Version: "v1alpha1", Resource: "functions"}

var functionsKind = schema.GroupVersionKind{Group: "kfn.dajac.io", Version: "v1alpha1", Kind: "Function"}
