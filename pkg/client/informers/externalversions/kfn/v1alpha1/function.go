...
import (
	...
	versioned "github.com/dajac/kfn/pkg/client/clientset/versioned"
	internalinterfaces "github.com/dajac/kfn/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/dajac/kfn/pkg/client/listers/kfn/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KfnV1alpha1().Functions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KfnV1alpha1().Functions(namespace).Watch(options)
			},
		},
		&kfnv1alpha1.Function{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *functionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kfnv1alpha1.Function{}, f.defaultInformer)
}
